...
def get_best_net(ip, net_range_list, net_int_list):
    ...
    # best_net = net_range_list[0]
    # for net in net_range_list:
    #     if ip[0] == net[0]

# datfile = 'ip.txt'
# net_range_list = read_ip_dat(datfile)
# print(get_best_net('49.114.165.195', net_range_list))
# # print(ip_to_int('1.3.4.5'))
# exit()


# def ip_in_china_old(ip, net_range_list):
#     IP = IPy.IP
#     for net_range in net_range_list:
#         if ip in IP(net_range):
#             return 1
#         else:
#             pass
#     else:
